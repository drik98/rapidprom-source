 ...
 * @author Hendrik
 */
public class MyOwnOperator2 extends Operator {
     ...
     * @param description
     */
    public MyOwnOperator2(OperatorDescription description) {
        super(description);
    ...
    public void doWork() throws OperatorException {
        ...
        Attribute newNameAttribute = AttributeFactory
                .createAttribute("Lieblingsmensch",
                        Ontology.ATTRIBUTE_VALUE_TYPE.NOMINAL);
        listOfAtts.add(newNameAttribute);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            doubleArray[2] = newNameAttribute.getMapping().mapString("Anna");
            // create an example
