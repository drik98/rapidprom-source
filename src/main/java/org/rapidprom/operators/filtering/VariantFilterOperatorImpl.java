...
//	private static final String PARAMETER_DESC_FILTER_THRESHOLD = "Set the filtering threshold which is used for outlier detection";
	...
	private static final String PARAMETER_DESC_SUBSEQUENT_LENGTH = "Set the Percentage of variants that want to be kept";
...
//				false));
		params.add(new ParameterTypeInt(PARAMETER_KEY_SUBSEQUENT_LENGTH, PARAMETER_DESC_SUBSEQUENT_LENGTH, 1, 100, 75,
				false));
