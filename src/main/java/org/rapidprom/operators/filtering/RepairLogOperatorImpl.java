...
public class RepairLogOperatorImpl extends AbstractFilteringOperator {
	...
	private static final String PARAMETER_DESC_SUBSEQUENT_LENGTH = "Set the subsequent length which is used for Repairing";
...
//		parameters.setFilteringSelection(Selection_OPTIONS_List[getParameterAsInt(PARAMETER_KEY_Selection_Method)]);
		...
		getOutputLogPort().deliver(new XLogIOObject(RepairLog.run(context, noisyLog, parameters), context));
	}
